          ...
          {notifications.map((n, i) => (
            <div key={i}>
              ...
              <div onClick={() => { if (n.action) { n.action(); setOpen(false); } }}
                ...
                onMouseEnter={e => { if (n.action) (e.currentTarget as HTMLDivElement).style.background = themeStyles.border; }}
            ...
            <div key={gi}>
              ...
              {group.map(item => (
                <button key={item} onClick={() => handleItemClick(item)}
                  ...
                  onMouseEnter={e => { e.currentTarget.style.background = themeStyles.border; e.currentTarget.style.color = themeStyles.primaryText; }}
